...
#...............................................................................
# Load databases
  DB_Message      =   paste('IARP Version 1.6'); print(DB_Message)
         ...
         # Clean all varibales and screen
           observe({
                     ...
                     # Create a Progress object
                       ...
                       {if (is.null(value)) {value <- progress$getValue(); value <- value + (progress$getMax() - value) / 7; Sys.sleep(0.1)}
                       progress$set(value = value, detail = detail)}
                     #-------------------------------------------------------------------------------------------------

                     #-------------------------------------------------------------------------------------------------
                     # Clear All Major Variables
                       ...
                       MNAIS_Display_Dissaggregated_exposure.final <<- NULL
                       WBCIS_Display_Dissaggregated_exposure.final <<- NULL
                     #-------------------------------------------------------------------------------------------------
                     ...
                     #-------------------------------------------------------------------------------------------------
                       ...
                       if (is.function(updateProgress)) {updateProgress(detail = 'Previous analysis and variables cleared ....')}
                       if (is.function(updateProgress)) {updateProgress(detail = 'Previous analysis and variables cleared ....')}
                       if (is.function(updateProgress)) {updateProgress(detail = 'Previous analysis and variables cleared ....')}
                       if (is.function(updateProgress)) {updateProgress(detail = 'Previous analysis and variables cleared ....')}
                       if (is.function(updateProgress)) {updateProgress(detail = 'Previous analysis and variables cleared ....')}
               ...
               # Compute MNAIS Simulation
                 observe({
                         ...
                         # Create a Progress object
                           ...
                           if(is.null(MNAIS_Dissaggregated_exposure.db))
                              {
                               if (is.function(updateProgress)) {updateProgress(detail = 'MNAIS - Array not found .................')}
                               if (is.function(updateProgress)) {updateProgress(detail = 'MNAIS - Array not found .................')}
                               if (is.function(updateProgress)) {updateProgress(detail = 'MNAIS - Array not found .................')}
                               if (is.function(updateProgress)) {updateProgress(detail = 'MNAIS - Array not found .................')}
                               if (is.function(updateProgress)) {updateProgress(detail = 'MNAIS - Array not found .................')}
